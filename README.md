...
Este arquivo contém o código para o servidor administrador com interface gráfica. Ele permite que o administrador bloqueie ou desbloqueie endereços IP.
...
2. Na interface gráfica que aparecer, clique em "Iniciar Servidor" para começar a aceitar conexões de clientes.
3. Use os botões "Bloquear IP" e "Desbloquear IP" para gerenciar os acessos dos clientes.
4. Use o botão "Escanear Rede" para encontrar clientes na rede local.
...
- `admin_server_gui.py`: Contém a lógica do servidor e a interface gráfica para gerenciamento de IPs bloqueados e escaneamento da rede.
